...
export default function ColorPicker({ color, onChange }: Readonly<ColorPickerProps>) {
  ...
  return (
    <div className='px-2 color-picker-wrapper dark:bg-black-700' ref={innerDivRef}>
          ...
          <Popover
            content={
              <div className='flex flex-col w-full gap-2'>
                <MoveWrapper
                  className='rounded-md color-picker-saturation w-44 dark:bg-black-600'
                ...
                <MoveWrapper
                  className='color-picker-hue w-44 dark:bg-black-600'
                  onChange={onMoveHue}
                >
                  <div
                ...
                <Input
                  className='w-44 dark:bg-black-600 dark:text-white dark:border-gray-700'
                  placeholder='Enter hex color'
                  prefix={
                    <div className='w-5 h-5 rounded-full' style={{ backgroundColor: inputColor }} />
                  }
            ...
            showArrow={false}
          >
            <button className='relative flex items-center justify-center w-5 h-5 rounded-full'>
              <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-3.5 w-3.5 rounded-full flex items-center justify-center bg-white'>
                <AddIcon className='text-gray-600' sx={{ fontSize: 12 }} />
              </div>
            </button>
          </Popover>
        </div>
